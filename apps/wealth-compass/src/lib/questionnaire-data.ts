...
export const QUESTIONS: Question[] = [
  {
    ...
    options: [
      ...
      { letter: "D", label: "Split it according to my jar system" },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { letter: "D", label: "I check my jar allocations before making big purchases" },
    ],
    answerMap: { A: "spender", B: "saver", C: "avoider", D: "balanced" },
  },
  {
    ...
    options: [
      ...
      { letter: "D", label: "I budget for treats in my PLAY jar" },
    ],
    answerMap: { A: "spender", B: "saver", C: "avoider", D: "balanced" },
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { letter: "D", label: "Confident - my FFA jar is building toward it" },
    ],
    answerMap: { A: "spender", B: "saver", C: "avoider", D: "balanced" },
  },
]
